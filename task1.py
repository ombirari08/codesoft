...
#Button widget 
entry_button=Button(window,text="Add task",width=50,command=entertask,bg="blue",fg="white")
entry_button.pack(pady=3)

delete_button=Button(window,text="Delete selected task",width=50,command=deletetask,bg="blue",fg="white")
